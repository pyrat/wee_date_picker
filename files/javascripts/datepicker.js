/*
        DatePicker v2.9 by frequency-decoder.com
...
function datePicker(options) {
        ...
        o.getDisabledDates = function(y, m) {
                var obj = {};
                var d = datePicker.getDaysPerMonth(m, y);
                m = m < 10 ? "0" + m : m;
        ...
        o.setDateFromInput = function() {
                ...
                if(!dates[y] || !dates[m] || !dates[d] || new Date( dates[y], dates[m], dates[d] ) == 'Invalid Date' || new Date( dates[y], dates[m], dates[d] ) == 'NaN') {
                        o.date = new Date();
                        return;
                };
